...
6. [Domain-Specific Constructs](#domain-specific-constructs)
7. [Examples](#examples)
8. [Grammar Reference](#grammar-reference)
...
3. **FFI Library Calls** (Zero Tokens)
   ```vl
